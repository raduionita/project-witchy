...
class _$AuthSessionImpl implements _AuthSession {
  ...
  @override
  String toString() {
    return 'AuthSession(id: $id, displayName: $displayName, email: $email, provider: $provider, signedInAt: $signedInAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, displayName, email, provider, signedInAt);
...
abstract class _AuthSession implements AuthSession {
  const factory _AuthSession({
    ...
    required final DateTime signedInAt,
  }) = _$AuthSessionImpl;
