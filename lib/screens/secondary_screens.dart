    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          WitchyCard(
            ...
            child: Column(
              ...
              children: [
                ...
                const Row(children: [Icon(Icons.water_drop, size: 18, color: AppColors.gold), SizedBox(width: 5), Icon(Icons.water_drop, size: 18, color: AppColors.gold), SizedBox(width: 5), Icon(Icons.water_drop, size: 18, color: AppColors.gold)]),
              ],
            ),
          ),
          WitchyCard(
          ...
          WitchyCard(child: WitchySliderRow(label: 'Uterine Contraction Pain', value: 'Level ${log.pain.round()}', min: 0, max: 10, current: log.pain, onChanged: (v) => context.read<LogProvider>().setPain(v))),
          WitchyCard(
          ...
          WitchyCard(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                ClipRRect(borderRadius: BorderRadius.circular(3), child: LinearProgressIndicator(value: 0.30, minHeight: 6, backgroundColor: Colors.white.withValues(alpha: .22), valueColor: const AlwaysStoppedAnimation(AppColors.gold))),
                const SizedBox(height: 8),
          ...
          WitchyCard(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                Text('First-trimester tiredness is shifting. Elevate your iron levels with organic spinach potions and continue speaking soft, loving mantras to your belly.', style: AppText.sans(11.5, h: 1.55)),
              ],
            ),
          ),
        ],
...
class _CovenScreenState extends State<CovenScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const WitchyAppBar(title: 'Coven Sanctum'),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(i == 0 ? 'Recent Whispers' : "Ancients' Wisdom",
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    ...
                    const SizedBox(width: 10),
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(p.author, style: AppText.serif(12.5)), Text(p.meta, style: AppText.sans(9, c: AppColors.muted))])),
                    WitchyTag(p.tag),
                  ]),
                  const SizedBox(height: 8),
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text(a.category, style: AppText.sans(8.5, w: FontWeight.w700, c: AppColors.gold).copyWith(letterSpacing: 1.0)), Text(a.readTime, style: AppText.sans(9, c: AppColors.muted))]),
              ...
              child: Column(
                children: [
                  Row(children: [
                    ...
                    const SizedBox(width: 10),
                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(rp.items[i].title, style: AppText.serif(12.5)), Text(rp.items[i].subtitle, style: AppText.sans(9.5, c: AppColors.muted))])),
                  ...
                  if (rp.items[i].enabled) ...[
                    ...
                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [InfoPill(icon: Icons.schedule_outlined, label: rp.items[i].time), InfoPill(icon: Icons.auto_awesome, label: rp.items[i].freq)]),
                  ],
                ],
              ),
            ),
      ...
      body: ListView(
        ...
        children: [
          WitchyCard(
            child: Column(
              children: [
                const Row(mainAxisAlignment: MainAxisAlignment.center, children: [WitchyAvatar(initials: 'HS'), SizedBox(width: 12), Icon(Icons.auto_awesome, color: AppColors.gold, size: 26), SizedBox(width: 12), WitchyAvatar(initials: 'KP')]),
                const SizedBox(height: 10),
          ...
          WitchyCard(
            child: Column(
              ...
              children: [
                ...
                SettingsRow(label: 'Share Bleeding Predictions', trailing: Switch(value: s.shareBleed, activeColor: AppColors.pur, onChanged: (v) => context.read<SettingsProvider>().setShareBleed(v)), first: true),
                ...
                SettingsRow(label: 'Share Anonymized Symptom Log', trailing: Switch(value: s.shareSymptoms, activeColor: AppColors.pur, onChanged: (v) => context.read<SettingsProvider>().setShareSymptoms(v))),
              ],
            ),
          ),
        ],
