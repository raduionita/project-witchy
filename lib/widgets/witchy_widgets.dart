    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [AppColors.primaryShadow],
        ),
        child: Row(
...
class WitchyAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const WitchyAppBar({super.key, required this.title, this.action, this.onAction});
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: SizedBox(
        ...
        child: Row(
          children: [
            IconButton(onPressed: () {}, icon: const Icon(Icons.menu, color: AppColors.chipText)),
            Expanded(child: Text(title, textAlign: TextAlign.center, style: AppText.appBar)),
            IconButton(
              onPressed: onAction,
              icon: Icon(action ?? Icons.auto_awesome, color: AppColors.pur),
            ),
          ],
        ),
      ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            if (icon != null) ...[
              Icon(icon, size: 12, color: selected ? Colors.white : (iconColor ?? AppColors.pur)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, size: 12, color: AppColors.pur),
          const SizedBox(width: 6),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(label, style: AppText.sans(12, w: FontWeight.w500, c: AppColors.ink)),
          trailing,
        ],
      ),
    );
      ...
      children: [
        if (label != null) ...[
          Padding(
            ...
            child: Text(label!, style: AppText.sans(10.5, w: FontWeight.w600, c: const Color(0xFF4D3B52))),
          ),
        ],
        TextField(
      ...
      children: [
        Row(
          ...
          children: [
            ...
            Text(value, style: AppText.serif(13.5, c: AppColors.pur)),
          ],
        ),
        SliderTheme(
          data: SliderTheme.of(context).copyWith(
            activeTrackColor: AppColors.pur,
...
class WitchyBottomNav extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const items = [
      ...
      (Icons.auto_fix_high_outlined, 'Magic'),
    ];
    return Container(
      height: 78,
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    if (i == index)
                      Container(margin: const EdgeInsets.only(top: 4), width: 18, height: 2.5, decoration: BoxDecoration(color: AppColors.pur, borderRadius: BorderRadius.circular(2))),
                  ],
                ),
              ),
            ),
